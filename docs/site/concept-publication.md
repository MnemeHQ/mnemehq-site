...
- Refer to [`PUBLISHING.md`](../../PUBLISHING.md) ("Diagrams are infrastructure
  evidence") for color roles and accessibility requirements. The original
  diagram-conventions note remains in the historical decision record in
  [MnemeHQ/mneme](https://github.com/MnemeHQ/mneme) (`docs/contributing/diagram-conventions.md`).
